...
echo "*********cleaning xit*********"
xmake xit/xmakefile.json clean
...
xmake xit.Timers/xmakefile.json clean
...
xmake xit.IO/xmakefile.json clean
...
xmake xit.Input/xmakefile.json clean
...
xmake xit.Clipboard/xmakefile.json clean
...
xmake xit.Security/xmakefile.json clean
...
xmake xit.Threading/xmakefile.json clean
...
xmake xit.Application/xmakefile.json clean
...
xmake xit.Account/xmakefile.json clean
...
xmake xit.Drawing/xmakefile.json clean
