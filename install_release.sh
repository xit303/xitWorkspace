...
echo "*********Building xit*********"
xmake xit/xmakefile.json install -c Release
...
xmake xit.Timers/xmakefile.json install -c Release
...
xmake xit.IO/xmakefile.json install -c Release
...
xmake xit.Input/xmakefile.json install -c Release
...
xmake xit.Clipboard/xmakefile.json install -c Release
...
xmake xit.Security/xmakefile.json install -c Release
...
xmake xit.Threading/xmakefile.json install -c Release
...
xmake xit.Application/xmakefile.json install -c Release
...
xmake xit.Account/xmakefile.json install -c Release
...
xmake xit.Window/xmakefile.json install -c Release
...
xmake xit.Drawing/xmakefile.json install -c Release
