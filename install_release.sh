...
# This script installs the complete xit project using xmake.
...
echo "*********Building xit*********"
xmake xit/xmakefile.json install --config Release
...
xmake xit.Timers/xmakefile.json install --config Release
...
xmake xit.IO/xmakefile.json install --config Release
...
xmake xit.Input/xmakefile.json install --config Release
...
xmake xit.Clipboard/xmakefile.json install --config Release
...
xmake xit.Security/xmakefile.json install --config Release
...
xmake xit.Threading/xmakefile.json install --config Release
...
xmake xit.Application/xmakefile.json install --config Release
...
xmake xit.Account/xmakefile.json install --config Release
...
xmake xit.Window/xmakefile.json install --config Release
...
xmake xit.Drawing/xmakefile.json install --config Release
